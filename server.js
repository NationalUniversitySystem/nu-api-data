...
const SLACK_WEBHOOK_URL = process.env.SLACK_WEBHOOK_URL || 'https://hooks.slack.com/services/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';

// Function to send error to Slack
async function sendErrorToSlack(error, req) {
    if (!SLACK_WEBHOOK_URL || SLACK_WEBHOOK_URL.includes('your/webhook/url')) return;
    const message = {
